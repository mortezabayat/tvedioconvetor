package com.morteza.videocompressor.file;
...
public class FileUtils {
    ...
    public static void createApplicationFolder() {
        ...
        f.mkdirs();
        f = new File(Environment.getExternalStorageDirectory(),
                File.separator + Config.VIDEO_COMPRESSOR_APPLICATION_DIR_NAME + Config.VIDEO_COMPRESSOR_TEMP_DIR);
        f.mkdirs();
    }
    ...
    public static File saveTempFile(String fileName, Context context, Uri uri) {
        ...
        try {
            ...
            mFile = new File(Environment.getExternalStorageDirectory().getPath() + File.separator +
                    Config.VIDEO_COMPRESSOR_APPLICATION_DIR_NAME + Config.VIDEO_COMPRESSOR_TEMP_DIR, fileName);
